...
export default function ToolError({
  ...
  return (
    <div className="container mx-auto px-4 py-16 text-center">
      <h1 className="text-3xl font-bold text-secondary mb-4">Herramienta no encontrada</h1>
      <p className="text-gray-600 mb-8">
        Lo sentimos, no pudimos encontrar la herramienta que estás buscando o ha ocurrido un error.
      </p>
